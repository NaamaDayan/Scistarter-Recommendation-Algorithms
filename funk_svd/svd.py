...
class SVD():
    ...
    def __init__(self, explanation_matrix, learning_rate=.005, regularization=0.01, lambda_ = 0.02, n_epochs=20,
                 n_factors=100, min_rating=1, max_rating=2):
        ...
        self.explanatoin_matrix = explanation_matrix
    ...
    def _sgd(self, X, X_val):
        ...
        for epoch_ix in range(self.n_epochs):
            ...
            pu, qi, bu, bi = _run_epoch(X, pu, qi, bu, bi, self.global_mean,
                                        self.n_factors, self.lr, self.reg, self.lambda_, self.explanatoin_matrix.values,
                                         list(self.user_dict.keys()), list(self.user_dict.values()), list(self.item_dict.keys()),
                                        list(self.item_dict.values()), [int(i) for i in self.explanatoin_matrix.columns])
